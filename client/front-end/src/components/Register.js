...
export default class Register extends Component {
    ...
    save = (e) => {
        e.preventDefault();
        let user = { name: this.state.name, email: this.state.email, password: this.state.password, phone: this.state.phone, address: this.state.address };
        console.log('user => ' + JSON.stringify(user));

        Services.addUser(user).then(res => {
